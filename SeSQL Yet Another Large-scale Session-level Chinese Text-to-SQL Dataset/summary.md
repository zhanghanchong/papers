...
* 结果
  ...
  * SeSQL与CHASE对比
    ...
    第一，CHASE-C和CHASE-T直接差异很大。相较于仅使用CHASE-C作为训练集，使用完整的CHASE导致在CHASE-C验证集上的性能下降。换言之，CHASE-T引入了更多的噪声信息而非有效信息。然而相较于仅使用CHASE-T作为训练集，使用完整的CHASE又能提升CHASE-T验证集上的性能。
